      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full px-6">
        {projects.map((project, index) => (
          <div key={index} className="flex flex-col rounded-2xl p-8 backdrop-blur-xl bg-white/5 border border-white/10 hover:border-[#f47346]/80 transition-all duration-400 hover:shadow-[0_0_35px_rgba(244,115,70,0.2)] group hover:-translate-y-2">
            ...
            <a href={project.link} className="inline-flex items-center gap-2 mt-auto w-fit text-sm font-bold text-white uppercase tracking-wider border-b-2 border-transparent hover:border-[#f47346] pb-1 transition-all duration-300">
